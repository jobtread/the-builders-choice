        ...
        <div className='md:flex md:justify-between md:gap-4 mx-auto'>
          <div className='text-center mb-12 md:mb-0 md:text-left text-xs'>
            <div>
              <a
                ...
                rel='noreferrer'
                target='_blank'
                className='text-cyan-500 focus:text-cyan-600 hover:text-cyan-600 relative cursor-pointer mx-auto md:mx-0 inline-block max-w-sm mb-1'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  id='ad971c73-828d-493a-9d6b-71fa58f4329a'
                  data-name='Layer 1'
          ...
          <div className='text-center md:text-right'>
            ...
            <div className='text-center md:text-right text-sm'>
              <a
                href='https://app.jobtread.com/help'
                className='text-cyan-500 focus:text-cyan-600 hover:text-cyan-600 relative cursor-pointer text-center md:text-right my-8 md:my-0'
              >
                Support
              </a>
              ...
              <a
                href='https://www.jobtread.com/terms'
                rel='noreferrer'
                target='_blank'
                className='text-cyan-500 focus:text-cyan-600 hover:text-cyan-600 relative cursor-pointer text-center md:text-right my-8 md:my-0'
              >
              ...
              <span className='mx-1 text-xs text-gray-500'> | </span>
              <a
                href='https://www.jobtread.com/privacy-policy'
                rel='noreferrer'
                target='_blank'
                className='text-cyan-500 focus:text-cyan-600 hover:text-cyan-600 relative cursor-pointer text-center md:text-right my-8 md:my-0'
              >
